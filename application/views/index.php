									...
									<ul class="d-flex flex-row align-items-start justify-content-start">
										...
										<li>
											...
											if (!empty($this->session->userdata('nama'))) { ?>
												<a href="<?php echo base_url('pemesanan/index/'.$this->session->userdata['id']); ?>">Pemesanan</a>											
											<?php }else{ ?>
												<a href="<?php echo base_url('auth/login'); ?>">Pemesanan</a>
											<?php }?>
										...
										<li>
											<?php 
											if (!empty($this->session->userdata('nama'))) { ?>
												<a href="<?php echo base_url('auth/logout'); ?>"><?php echo $this->session->userdata('nama'); ?></a>											
											<?php }else{ ?>
