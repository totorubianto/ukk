					...
					<!-- <div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control" type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<form method="post" action="<?php echo base_url() ?>admin/addRute/">
									...
									<div class="modal-body">
										...
										<div class="form-group">
											...
											<input class="form-control" type="number" name="jumlah_kursi">
										</div>
										<div class="form-group">
											<label>Nama Pesawat</label>
											<input class="form-control" type="text" name="nama_type">
										</div>
										<div class="form-group">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<select class="form-control" name="cari_rute_awal">
									<?php foreach ($rute_awal->result() as $city) { ?>
										<option value="<?php echo $city->id_kota; ?>"><?php echo $city->nama_kota; ?></option>
									<?php } ?>
								</select>
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label>Rute awal</label>
								<select class="form-control" name="cari_rute_akhir">
									<?php foreach ($rute_akhir->result() as $city) { ?>
										<option value="<?php echo $city->id_kota; ?>"><?php echo $city->nama_kota; ?></option>
									<?php } ?>
								</select>
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label>Cari</label>
								<input class="form-control btn btn-primary" value="cari" type="submit" name="">
							</div>
				...
				<div class="table-responsive">
					<table class="table align-items-center">
						<thead class="thead-light">
							<tr>
								<th scope="col">id</th>
								<th scope="col">Rute_Awal</th>
								<th scope="col">Rute_Akhir</th>
